...
def tcgen(sel_month, name, f_name, wnum):
    ...
    SHIFTPATH = os.path.join(BASE_DIR, f'djsg/media/djsg/shifts/{sel_month}のShift.xlsx')
    TCPATH = os.path.join(BASE_DIR, 'djsg/media/djsg/tc.xlsx')
    ...
    colR = []
    colS = []
    biglist = [colA,colB,colC,colD,colE,colF,colG,colH,colI,colJ,colK,colL,colM,colN,colO,colP,colQ,colR,colS]
    lis = []
    ...
    tc.save(os.path.join(BASE_DIR, f"djsg/media/djsg/timecards/{nextmonth}月勤務報告書（{name}）.xlsx"))
